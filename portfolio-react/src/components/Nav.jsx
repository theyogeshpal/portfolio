      ...
      <nav id="navbar" className="fixed w-full z-50 transition-all duration-300 top-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
                ...
                <div className="hidden md:flex space-x-6 items-center">
                    ...
                    <a href="#education" className="nav-link text-gray-700 hover:text-orange-600 font-semibold relative group py-1">Education<span className="absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-orange-500 to-orange-700 rounded-full w-0 group-hover:w-full transition-all duration-300"></span></a>
        ...
        <div id="mobile-menu" className="hidden md:hidden bg-[#0a0a0a] border-t border-gray-800 absolute w-full shadow-2xl h-screen overflow-y-auto pb-20">
            <div className="px-4 pt-2 pb-6 space-y-1">
                ...
                <a href="#education" className="mobile-nav-link block px-3 py-2 rounded-md text-base font-semibold text-gray-300 hover:text-orange-600 hover:bg-[#1a1a1a]">Education</a>
